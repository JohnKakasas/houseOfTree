...
public class App {
    ...
    // οθόνη της κονσόλας, και έξοδος από το πρόγραμμα. Ο κώδικας χρησιμοποιεί ένα βρόχο while και ένα
    ...
    public static void menu() {
        ...
        while (!menu) {
            ...
            System.out.println("1. Βρείτε την οικογενειακή σχέση μεταξύ δύο ατόμων.");
            System.out.println("2. Εμφάνιση όλων των ατόμων από το αρχείο.");
    ...
    // Αυτός ο κώδικας δημιουργεί μια μέθοδο που επιτρέπει στο χρήστη να αποφασίσει αν θέλει να
    // να συνεχίσει να χρησιμοποιεί το πρόγραμμα ή να το εγκαταλείψει. Η μέθοδος ζητάει από το χρήστη με ένα
    ...
    // if-else για να ελέγξει την επιλογή του χρήστη. Εάν ο χρήστης επιλέξει «Y», ο κώδικας
    ...
    // Εάν ο χρήστης εισάγει μια μη έγκυρη επιλογή, εμφανίζεται ένα μήνυμα σφάλματος και η
    ...
    // Ο κώδικας διαβάζει το περιεχόμενο ενός αρχείου CSV και το αποθηκεύει σε ένα String
    // μεταβλητή. Χρησιμοποιεί ένα μπλοκ try-catch για τον χειρισμό τυχόν σφαλμάτων που μπορεί να προκύψουν κατά τη διάρκεια του
    ...
    // Αυτός ο κώδικας διαβάζει και επεξεργάζεται το περιεχόμενο ενός αρχείου CSV, δημιουργεί ένα Map και ένα
    // λίστα για την αποθήκευση των δεδομένων και καλεί τη μέθοδο «findRelation» για την εύρεση της σχέσης
    // μεταξύ δύο ονομάτων που καθορίζονται από τον χρήστη. Εάν βρεθεί μια σχέση θα είναι
    ...
    public static void readData() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            if (relation != null) {
                ...
                else System.out.println("Ο " + inputName1 + " είναι " + relation + " σε " + inputName2);
    ...
    // Οι ιδιωτικές στατικές κλάσεις ελέγχουν τις συγγενικές σχέσεις μεταξύ των ατόμων με
            ...
            for (Tree tree : trees) {
                for (Person person : tree.getPersons()) {
                    if (person.getName().equals(name1)) {
                        if (tree.getRelation().equals("husband")) return "σύζυγος";
                    }
                }
            }
        }
    ...
    // ανθρώπων. Κάθε μέθοδος αξιολογείται με τη σειρά και όταν βρεθεί μια αντιστοιχία, η
